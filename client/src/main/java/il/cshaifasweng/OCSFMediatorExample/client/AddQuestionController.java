...
public class AddQuestionController {
	...
	private static AddQuestionController addQuestionController;
    ...
    void qsubmitac(ActionEvent event) throws IOException {
    	   ...
    	   for(Subject subject : subjects) {
    			  ...
    			  Answer answer1 = new Answer(); Answer answer2= new Answer(); Answer answer3 =
    			  new Answer(); Answer answer4 = new Answer();
    			  answer1.setAnswer(answer1txt.getText());
    			  answer1.setAnswer(answertxt2.getText());
    			  answer1.setAnswer(answertxt3.getText());
    			  answer1.setAnswer(answertxt4.getText()); Question newQuestion = new
    			  Question(qusttxt.getText(),answer1,answer2,answer3,answer4,chosenAnswer, chosenSubject); 
    			  App.getInstance().AddQuestion(newQuestion);
